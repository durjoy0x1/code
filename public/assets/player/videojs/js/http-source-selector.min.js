...
!(function (e, t) {
  ...
  var s = function (e, t) {
    ...
    })(i.getComponent("MenuItem")),
    c = i.getComponent("MenuButton"),
    o = (function (r) {
      function l(e, t) {
        s(this, l);
        var o = a(this, r.call(this, e, t));
        c.apply(o, arguments);
        var n = o.player().qualityLevels();
        if (t && t.default)
          if ("low" == t.default)
            for (var i = 0; i < n.length; i++) n[i].enabled = 0 == i;
          else if ((t.default = "high"))
            for (i = 0; i < n.length; i++) n[i].enabled = i == n.length - 1;
        return o;
      }
      return (
        e(l, r),
        (l.prototype.createEl = function () {
          return i.dom.createEl("div", {
            className:
              "vjs-http-source-selector vjs-menu-button vjs-menu-button-popup vjs-control vjs-button",
          });
        }),
        (l.prototype.buildCSSClass = function () {
          return c.prototype.buildCSSClass.call(this) + " vjs-icon-cog";
        }),
        (l.prototype.update = function () {
          return c.prototype.update.call(this);
        }),
        (l.prototype.createItems = function () {
          for (
            ...
            var i = t.length - (n + 1),
              ...
              s = i;
            t[i].height
              ? ((l = t[i].height + "p"), (s = parseInt(t[i].height, 10)))
              : t[i].bitrate &&
                ((l = Math.floor(t[i].bitrate / 1e3) + " kbps"),
                (s = parseInt(t[i].bitrate, 10))),
              0 <= o.indexOf(l) ||
                (o.push(l),
                e.push(
                  new u(this.player_, {
    ...
    r = function (e) {
      ...
      this.ready(function () {
        ...
        })(t, i.mergeOptions(n, e));
      }),
        i.registerComponent("SourceMenuButton", o),
        i.registerComponent("SourceMenuItem", u);
    };
  return t("httpSourceSelector", r), (r.VERSION = "1.1.5"), r;
});
