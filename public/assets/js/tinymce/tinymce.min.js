...
!(function () {
  ...
  function Og(u, s, e) {
    var t,
      n =
        ((t = s),
        ke(ke({ format: "html" }, e), { set: !0, content: Rg(t) ? "" : t })),
        ...
        getContent: function (e, t) {
          return (
            ...
            he
              .from(d.getBody())
              .fold(
                J("tree" === m.format ? new Jd("body", 11) : ""),
                function (e) {
                  return (
                    (t = d),
                    (r = e),
                    ...
                    (f =
                      "raw" === l.format
                        ? St.trim(cm(t.serializer, r.innerHTML))
                        : "text" === l.format
                        ? t.dom.isEmpty(r)
                          ? ""
                        ...
                        : ((a = (i = t).serializer.serialize(r, l)),
                          ...
                          a.replace(s, ""))),
                    ie(["text", "tree"], l.format) || To(Et.fromDom(r))
                      ? (l.content = f)
                      : (l.content = St.trim(f)),
